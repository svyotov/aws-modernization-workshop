...
+
Step 16:: From the drop-down *Container to load balance* drop-down list, select the container you created. Is should be called *[red yellow-background]#<User Name>#-petstore:8080:8080* (_substituting your user name_). Click rthe *Add to load balancer* button.
+
