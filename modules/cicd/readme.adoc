...
+
NOTE: We will not create a *Deployment Stage* to our pipeline because we will leverage an AWS Lambda function to act as a Kubernetes client to deploy our aplication.
+
