...
[source,shell]
----
aws cloudformation create-stack --stack-name "${User_Name}-petstore-ecr" --template-body file://petstore-ecr-cf-resources.yaml --capabilities CAPABILITY_NAMED_IAM
----
+
...
[source,shell]
----
aws ecr describe-repositories --repository-name ${USsere_Name}-petstore_postgres ${User_Name}-petstore_frontend
----
+
Expceted output:
+
